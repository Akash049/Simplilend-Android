...
import com.simplielend.simplilend.Adapters.Disbursement_loan_adapter;
...
public class DisbursementLoans extends AppCompatActivity {
    ...
    RecyclerView view4;
    Disbursement_loan_adapter disbursement_loan_adapter;
    ImageView exit;
    Button back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        disbursement_loan_adapter= new Disbursement_loan_adapter(this,getMyList());
        view4.setAdapter(disbursement_loan_adapter);
