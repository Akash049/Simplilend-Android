...
public class Disbursement_loan_adapter extends RecyclerView.Adapter<Active_loan_holder> {

    Context c;
    ArrayList<Activeloan> activeloans;
    public Disbursement_loan_adapter(Context c, ArrayList<Activeloan> activeloans) {
        this.c = c;
    ...
    public Active_loan_holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.disbursement_loan_item,parent,false);
